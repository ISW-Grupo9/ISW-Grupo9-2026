...
class CompraTest {
  ...
  private Compra compraValida() {
    ...
    return new Compra(
        1L, LocalDate.now().plusDays(3), visitantes, FormaPago.EFECTIVO, new BigDecimal("5000"));
  }
  ...
  void debe_almacenar_fecha_de_visita() {
    ...
    var visitantes = List.of(new Visitante("Ana García", 28, TipoPase.REGULAR));
    var compra =
        new Compra(1L, fechaEsperada, visitantes, FormaPago.EFECTIVO, new BigDecimal("5000"));
