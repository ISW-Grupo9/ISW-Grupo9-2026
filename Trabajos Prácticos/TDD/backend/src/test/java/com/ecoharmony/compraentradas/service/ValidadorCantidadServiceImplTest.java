...
class ValidadorCantidadServiceImplTest {
  ...
  void debe_rechazar_cantidad_0() {
    assertThatThrownBy(() -> validador.validar(0)).isInstanceOf(CantidadInvalidaException.class);
  }
  ...
  void debe_rechazar_cantidad_negativa() {
    assertThatThrownBy(() -> validador.validar(-1)).isInstanceOf(CantidadInvalidaException.class);
  }
  ...
  void debe_rechazar_cantidad_11() {
    assertThatThrownBy(() -> validador.validar(11)).isInstanceOf(CantidadInvalidaException.class);
  }
}
